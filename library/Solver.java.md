...
data:
  ...
  code: "package library;\n\nabstract public class Solver implements Runnable {\n\t\
    ...
    \ i < n; i ++) a[i] = str.charAt(i);\n\t\treturn a;\n\t}\n\tpublic static final\
    \ char[][] nc(final int n, final int m) { final char a[][] = new char[n][m]; for(int\
    \ i = 0; i < n; i ++) a[i] = nc(m); return a; }\n\tpublic static final boolean[]\
